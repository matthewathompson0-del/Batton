 ...
 * @author matth
 */
public class EditStockGUI extends javax.swing.JFrame {

    /**
     * Creates new form EditStockGUI
     */
    User user;

    public EditStockGUI(User inUser) {
        user = inUser;
        initComponents();
...
//END OF SORTER        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditStockGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new EditStockGUI(test).setVisible(true);
            }
        });
    }
